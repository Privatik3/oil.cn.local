...
*/
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/review/store_review.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/module/review/store_review.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/module/review/store_review.tpl', $data));
        }
    ...
    public function review() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/review/store_review_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/module/review/store_review_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/module/review/store_review_list.tpl', $data));
        }
    }
