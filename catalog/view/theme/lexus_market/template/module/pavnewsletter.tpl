<div class="box newsletter <?php echo $prefix; ?>" id="newsletter_<?php echo $position.$module;?>">
		...
		<div class="box-heading"><span><?php echo $objlang->get("entry_newsletter");?></span></div>				
			...
			<form id="formNewLestter" method="post" action="<?php echo $action; ?>" class="formNewLestter">
				...
				<div class="input-group-btn">
						<button type="submit" name="submitNewsletter" class="button"><?php echo $objlang->get("button_subscribe");?></button>
					</div>	
