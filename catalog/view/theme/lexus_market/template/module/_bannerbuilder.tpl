<?php foreach ( $rows as $row) { 
	    ...
	    <?php if ( $level==1 ){	 ?>
	        <div class="pts-container <?php if ( isset($row->parallax)&&$row->parallax ) { ?> pts-parallax <?php } ?>" <?php echo $row->attrs?>>        
	        	<div class="pts-inner">
	    <?php } ?>  
	    <div class="row row-level-<?php echo $level; ?>"><div class="row-inner <?php echo $row->cls; ?> <?php echo $class ?>">
	            ...
	            <div class="col-inner">
	                <?php foreach ( $col->widgets as $widget ){ ?>
	                    ...
	                    <div class="banner-wrapper effect ">
	                    	<?php if($widget->link ){ ?>
                        	<a href="#" class="overlay"></a><a href="<?php echo $widget->link; ?>"><img alt="img" src="<?php echo $url.'/image/'.$widget->image; ?>" class="img-responsive"></a>
                        	<?php }else { ?>
