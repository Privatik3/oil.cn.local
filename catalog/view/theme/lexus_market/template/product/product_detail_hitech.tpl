...
<div class="product-info">
   ...
   <div class="row product-content">
        ...
        <div id="product" class="row product-extra ">
                ...
                <div class="price">
                    <ul class="list-unstyled">
                        ...
                        <?php } else { ?>
                            ...
                            <li> <span class="price-old"> <?php echo $special; ?> </span> <span><?php echo $price; ?></span> </li>
                        <?php } ?>
                        <?php if ($tax) { ?>
            ...
            <div class="col-lg-7 col-md-12 col-sm-7 col-xs-7">
                <div class="product-action">
                    <div class="addcart">
                    <a id="button-cart" data-loading-text="<?php echo $text_loading; ?>"> <span><?php echo $button_cart; ?></span><i class="fa fa-plus-circle"></i></a>
                    </div>
                    <div class="wishlist"><a onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><span><?php echo $button_wishlist; ?></span></a></div>
                    <div class="compare"><a onclick="compare.addcompare('<?php echo $product_id; ?>');"><i class="fa fa-refresh"></i><span><?php echo $button_compare; ?></span></a></div>
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
                </div>
            </div>
            </div>
