<form class="form-horizontal">
  ...
  <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <div class="form-group" style="display: none;">
      ...
      <div class="col-sm-10">
        <input type="text" name="address_2" value="none" placeholder="<?php echo $entry_address_2; ?>" id="input-shipping-address-2" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
    ...
    <div class="form-group required" style="display: none;">
      ...
      <div class="col-sm-10">
        <input type="text" name="postcode" value="none" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="form-control" />
      </div>
    </div>
    <div class="form-group required" style="display: none;">
